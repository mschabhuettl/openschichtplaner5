...
#   LIB_SOURCE  Default libopenschichtplaner5[postgres]==1.22.1 (PyPI-Pin)
#   API_SOURCE  Default openschichtplaner5-api==1.19.1 (PyPI-Pin)
# ==============================================================================
...
ARG API_SOURCE="openschichtplaner5-api==1.19.1"
