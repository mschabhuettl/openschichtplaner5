        ...
        <table className="text-xs w-full">
          <thead>
            <tr className="bg-slate-100 dark:bg-slate-700">
              <th scope="col" className="px-2 py-2 text-left font-semibold text-slate-600 dark:text-slate-300 w-8">#</th>
              <th scope="col" className="px-2 py-2 text-center font-semibold text-slate-600 dark:text-slate-300 w-8">Status</th>
              {headers.map((h, i) => (
                <th scope="col" key={i} className="px-3 py-2 text-left font-semibold text-slate-700 dark:text-slate-300 whitespace-nowrap">{h}</th>
              ))}
            </tr>
          </thead>
          <tbody>
