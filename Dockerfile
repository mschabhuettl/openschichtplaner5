...
#   LIB_SOURCE  Default libopenschichtplaner5[postgres]==1.14.4 (PyPI-Pin)
#   API_SOURCE  Default openschichtplaner5-api==1.9.1 (PyPI-Pin)
# ==============================================================================
...
ARG API_SOURCE="openschichtplaner5-api==1.9.1"
