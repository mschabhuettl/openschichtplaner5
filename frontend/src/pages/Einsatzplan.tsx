      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm p-6" onClick={e => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="flex gap-2 pt-2">
            ...
            <button type="button" onClick={onClose} className="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 text-sm">
              Abbruch
            </button>
          </div>
        </form>
    ...
    <div className="fixed inset-0 z-[300] flex items-center justify-center bg-black/40" onClick={onClose}>
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm p-6" onClick={e => e.stopPropagation()}>
        ...
        {result ? (
          ...
          <div className="space-y-3">
            <div>
              <label className="block text-xs font-medium text-gray-600 mb-1">Ziel-Montag (Wochenanfang)</label>
              <input
                type="date"
                value={targetDate}
...
function TemplatesPanel({
  ...
  return (
    <div
      ref={ref}
      className="fixed z-[250] right-4 top-16 bg-white rounded-xl shadow-2xl border border-gray-200 w-80 max-h-[70vh] flex flex-col"
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-4 flex-wrap">
        ...
        <button
          ...
          className={`no-print px-3 py-1.5 text-sm rounded shadow-sm flex items-center gap-1.5 border ${showTemplatesPanel ? 'bg-indigo-50 border-indigo-300 text-indigo-700' : 'bg-white border-gray-300 text-gray-700 hover:bg-gray-50'}`}
