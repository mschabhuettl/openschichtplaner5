  ...
  return (
    ...
    >
      ...
      <div ref={dialogRef} className="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 max-w-md w-full mx-4 animate-scaleIn">
        ...
        <button
          onClick={onCancel}
          className="absolute top-3 right-3 p-1 text-gray-600 hover:text-gray-600 dark:hover:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
