...
#   LIB_SOURCE  Default libopenschichtplaner5[postgres]==1.13.0 (PyPI-Pin)
#   API_SOURCE  Default openschichtplaner5-api==1.8.0 (PyPI-Pin)
# ==============================================================================
...
ARG API_SOURCE="openschichtplaner5-api==1.8.0"
