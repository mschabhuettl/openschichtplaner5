...
#   LIB_SOURCE  Default libopenschichtplaner5[postgres]==1.16.0 (PyPI-Pin)
#   API_SOURCE  Default openschichtplaner5-api==1.12.0 (PyPI-Pin)
# ==============================================================================
...
ARG LIB_SOURCE="libopenschichtplaner5[postgres]==1.16.0"
ARG API_SOURCE="openschichtplaner5-api==1.12.0"
